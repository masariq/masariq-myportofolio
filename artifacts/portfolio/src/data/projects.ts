...
export const projects: Project[] = [
  {
    ...
    date: "March 2024",
    shortBio:
      "A full redesign of Finvest's web platform — from a cluttered legacy interface to a clean, conversion-focused product. Scope included landing page, dashboard, and onboarding flow.",
    process:
      "We started with a thorough audit of the existing UI, mapping pain points and drop-off areas. From there, we built a new design system grounded in trust and clarity — muted tones, generous whitespace, and a strict type hierarchy. The final build used Next.js with Tailwind, deployed on Vercel with a headless CMS for the marketing pages.",
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1518186285589-2f7649de83e0?w=1400&q=85",
    ],
  },
  {
    id: 2,
