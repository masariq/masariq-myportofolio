    ...
    <section id="career" className="py-24 bg-foreground text-background">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col items-center text-center gap-10 max-w-3xl mx-auto">
          ...
          {/* 4-column info card */}
          <div className="rounded-2xl border border-background/10 bg-background/8 shadow-lg overflow-hidden w-full">
            <div className="grid grid-cols-2 md:grid-cols-4 divide-y md:divide-y-0 divide-x-0 md:divide-x divide-background/10">
              {[
                ...
                <div key={label} className="flex flex-col items-center gap-2.5 px-7 py-6 text-center">
